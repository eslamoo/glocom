  ...
  <div class="glocom-main d-flex" id="work-container">
    ...
    <main class="glocom-main__workplace w-100">
      <div class="glocom-main__workplace--board workplace " id="workplace">
        <div v-for="block in blocks" v-bind:style="{ top: block.top, left: block.left}" v-html="block.html"
          :id="block.id" v-bind:key="block.id" class="chart-item node">
        </div>
      </div>
    </main>
  </div>
    ...
    methods: {
      ...
      computeStyles() {
        this.blocks.forEach(block => {
          block.top = window.getComputedStyle(document.getElementById(block.id)).top;
